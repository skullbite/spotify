...
class DataIO():
    ...
    def save_json(self, filename, data):
        ...
        try:
            ...
            self.logger.exception("Attempted to write file {} but JSON integrity check on tmp file has failed. The original file is unaltered.".format(filename))
            return False
